...
public class ImprimirFrasesSincronizadas implements Runnable {
    private String frase1;
    private String frase2;

    public ImprimirFrasesSincronizadas(String frase1, String frase2) {
        setFrase1(frase1);
        setFrase2(frase2);
    }
    ...
    @Override
    public void run() {
        Frase.imprimirFrases(frase1,frase2);
    }
